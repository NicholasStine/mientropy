...
export function initializeGrid(indicies: any[], tiles: any[], updateFlagged: Function, getFailed: Function, setFailed: Function) {
    ...
    for (let i = 0; i < ROWS; i++) {
        ...
        for (let j = 0; j < COLUMNS; j++) {
            ...
            td.onclick = (e: MouseEvent) => onTileClick(e, tiles, updateFace, getFailed, setFailed)
            td.ondragenter = (e: MouseEvent) => onTileClick(e, tiles, updateFace, getFailed, setFailed)
...
export function initializeGame(updateFlagged: Function, getFailed: Function, setFailed: Function) {
    let indicies: any[] = []
    let tiles: any[] = []

    const [g_indicies, g_tiles] = initializeGrid(indicies, tiles, updateFlagged, getFailed, setFailed)
